...
class KC_potential_p:
    ...
    def adjust_forces(self, posits, forces):
        ...
        for k, pos_arr in enumerate(split_posits):
            ...
            #af1         =   multiprocessing.Array('d', np.zeros(len(pos_arr)))
            #af2         =   multiprocessing.Array('d', np.zeros(len(pos_arr)))
            #af3         =   multiprocessing.Array('d', np.zeros(len(pos_arr)))
        
            #ars.append([af1, af2, af3])
